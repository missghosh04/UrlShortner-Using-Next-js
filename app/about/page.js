...
export default function AboutPage() {
  return (
    <main className=" mx-auto p-6 text-gray-800 bg-gray-200 h-[75vh] flex flex-col  justify-center items-center ">
      ...
      <h1 className="text-3xl  font-bold mb-6 text-gray-800">About Bitlinks</h1>
      <div className="max-w-3xl text-gray-800 space-y-4 flex flex-col justify-center items-center">
      <p className="mb-4">
      ...
      <p className="mb-4">
        Whether you &rsquo;re sharing links on social media, messaging apps, or emails, Bitlinks helps you make your links look professional and trackable.
      </p>
      ...
      <p>
        ...
        <a 
          ...
          className="text-gray-800 font-bold hover:underline ml-1"
        >
          GitHub
        </a>.
      </p>
